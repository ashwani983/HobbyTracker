...
- [ ] 1. Internationalization (i18n)
  - [ ] 1.1 Set up Flutter l10n with ARB files
  ...
  - [ ] 1.2 Create translation files
    ...
    - _Requirements: 20.1_
  - [ ] 1.3 Replace all hardcoded strings with AppLocalizations references
    - All screens, widgets, error messages, button labels
    - _Requirements: 20.2_
  - [ ] 1.4 Implement LocaleCubit with manual override
    - Detect device locale, allow override in settings, persist preference
    - _Requirements: 20.3, 20.4_
  - [ ] 1.5 Ensure date/number formatting respects locale
    - _Requirements: 20.5_
  - [ ] 1.6 Add language selector to settings screen
    - _Requirements: 20.4_

- [ ] 2. Checkpoint — i18n

- [ ] 3. Social sharing
  - [ ] 3.1 Create ShareProgressCard data model
    - _Requirements: 17.2_
  - [ ] 3.2 Implement GenerateShareCard use case
    - Render styled widget to image using screenshot package
    - _Requirements: 17.1_
  - [ ] 3.3 Create share card widget with hobby stats and badge
    - _Requirements: 17.2_
  - [ ] 3.4 Add "Share" button to hobby detail and badge screens
...
- [ ] 5. AI suggestions
  - [ ] 5.1 Implement SuggestionEngine
  ...
  - [ ] 5.2 Create Suggestion entity and SuggestionCubit
    - Load suggestions, dismiss suggestions, persist dismissed IDs
    - _Requirements: 18.3, 18.5_
  - [ ] 5.3 Add suggestion cards to dashboard
    - Dismissible cards below summary, only shown after 20+ sessions
    - _Requirements: 18.1, 18.3_

- [ ] 6. Checkpoint — AI Suggestions

- [ ] 7. Home screen widgets
  - [ ] 7.1 Add home_widget dependency and configure native setup
    - Android: create widget layout XML and provider
    - iOS: create WidgetKit extension
    - _Requirements: 19.5_
  - [ ] 7.2 Implement small widget (today's time + streak)
    - _Requirements: 19.1_
  - [ ] 7.3 Implement medium widget (top 3 hobbies with weekly time)
    - _Requirements: 19.2_
  - [ ] 7.4 Write widget data on each session log
    - _Requirements: 19.4_
  - [ ] 7.5 Handle widget tap — deep link to dashboard
    - _Requirements: 19.3_
